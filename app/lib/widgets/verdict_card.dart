...
class _CitationRow extends StatelessWidget {
  ...
  Future<void> _openUrl() async {
    if (precedent.url.isEmpty) return;
    final uri = Uri.parse(precedent.url);
  ...
  Widget build(BuildContext context) {
    ...
    final hasUrl = precedent.url.isNotEmpty;
    return Container(
          ...
          if (hasUrl) ...[
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Icon(Icons.open_in_new, color: Colors.amber, size: 11),
              ),
            ),
          ],
        ]),
